ag1 <- wsf %>% 
        ...
        ggplot(aes(x = time, y= Asymptomatic, color = vac_group)) +
...
ggsave('delta_A.pdf', height = 12, width = 8, dpi = 300)
...
ag1 <- wsf %>% 
        filter(age_group == 'age1') %>% 
        ggplot(aes(x = time, y= Infectious, color = vac_group)) +
...
ggsave('delta_I.pdf', height = 12, width = 8, dpi = 300)
...
ggsave('omicron_A.pdf', height = 12, width = 8, dpi = 300)
...
ggsave('omicron_I.pdf', height = 12, width = 8, dpi = 300)
